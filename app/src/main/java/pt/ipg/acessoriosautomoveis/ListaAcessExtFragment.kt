...
private val adapterAcessExt1 : AdapterAcessExter
    get() {
        val adapterAcessExter = AdapterAcessExter()
        return adapterAcessExter
    }
...
class ListaAcessExtFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private val adapterAcessExter = AdapterAcessExter()
