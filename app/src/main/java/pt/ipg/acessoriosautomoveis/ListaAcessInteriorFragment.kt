...
class ListaAcessInteriorFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private var adapterAcessInte : AdapterAcessInter? = null

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val adapterAcessInter = AdapterAcessInter(this)
    ...
    private fun adicionaAcessInter() {
        val acao = ListaAcessInteriorFragmentDirections.actionListaAcessInteriorFragmentToEditarAcessInteriorFragment(null)
