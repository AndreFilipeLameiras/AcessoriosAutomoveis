...
private val adapterAcessInte1: AdapterAcessInter
    get() {
        val adapterAcessInte = AdapterAcessInter()
        return adapterAcessInte
    }
...
class ListaAcessInteriorFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private val adapterAcessInte = AdapterAcessInter()
